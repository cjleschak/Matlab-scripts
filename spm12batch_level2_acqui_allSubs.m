...
analysis_dir = 'Acquisition_hpf128ar1_allSubs_6sTrials';                                

groupstats_folder='_groupstats';                               % name of your groupstats folder
batch_dir = [studyDIR '_batches' filesep 'Level2' filesep];

explicit_mask = '/u/project/sanscn/data/TEMPLATES/greymatter_masks/grey_3x3x3trim.img';
...
gwd = [studyDIR groupstats_folder filesep taskID filesep analysis_dir];
...
for c = 1:conNum
    ...
    current_dwd=[gwd filesep current_conname_nosuffix '_' analysis_dir];
